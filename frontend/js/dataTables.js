...
(function (factory) {
  ...
  function _fnScrollDraw(settings) {
    ...
    $("th, td", headerCopy).each(function () {
      $(this.childNodes).wrapAll('<div className="dt-scroll-sizing">');
    });
    ...
    pagingButton: {
      _: function (settings, buttonType, content, active, disabled) {
        ...
        if (buttonType === "ellipsis") {
          btn = $('<span className="ellipsis"></span>').html(content)[0];
        } else {
          btn = $("<button>", {
  ...
  DataTable.feature.register(
    ...
    function (settings, opts) {
      ...
      var input = '<input type="search" className="' + classes.input + '"/>';
