            ...
            modifyTree(t) {
              let e = (i, s) => {
                ...
                if (
                  ("b" === h || "strong" === h
                    ? l
                      ? (r.className = "highcharts-strong")
                      : (a.fontWeight = "bold")
                    : ("i" === h || "em" === h) &&
                      (l
                        ? (r.className = "highcharts-emphasized")
                        : (a.fontStyle = "italic")),
                  a && a.color && (a.fill = a.color),
                  "br" === h)
                ) {
                  (r.className = "highcharts-br"), (i.textContent = "​");
                  let e = t[s + 1];
                  e &&
                    e.textContent &&
            ...
            styledModeFormat(t) {
              return t
                .replace(
                  ...
                  'className="highcharts-header"'
                )
                .replace(
                  /style="color:{(point|series)\.color}"/g,
                  'className="highcharts-color-{$1.colorIndex} {series.options.className} {point.options.className}"'
                );
            }
